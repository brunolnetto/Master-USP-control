ordefunction  traj = trajectory()
    ...
    q = [R*cos(omega*t); R*sin(omega*t); incl0*ones(size(t))].';
    qp = [-R*omega*sin(omega*t); R*omega*cos(omega*t); zeros(size(t))].';
...
%     qp4 = [qp4, incl0*zeros(m, 1)];
%     qpp4 = [qpp4, incl0*zeros(m, 1)];    
% 
%     % Whole rectangle
%     dt = t1(2) - t1(1);
