...
\section*{Exercício 6}
    ...
    \begin{figure}[H]
	\center
	\includegraphics[trim=200 200 200 200, width=0.3\textwidth]{./images/saida6zoh.pdf}
    ...
    \begin{figure}[H]
	\center
	\includegraphics[trim=200 200 200 200, width=0.3\textwidth]{./images/controle6zoh.pdf}
	\caption{Curva original e série amostrada}
	\label{fig:ex6saida}
    \end{figure}
    ...
    \begin{figure}[H]
	\center
	\includegraphics[trim=200 200 200 200, width=0.3\textwidth]{./images/erro6zoh.pdf}
	\caption{Curva original e série amostrada}
	\label{fig:ex1}
    \end{figure}
