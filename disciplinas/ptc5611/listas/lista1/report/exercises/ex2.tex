...
\addcontentsline{toc}{section}{Exercício 2}
    ...
    Ambos os sinais apresentam a mesma transformada $\mathcal{Z}$, apesar de serem distintos. Além disso, as regiões de convergência de ambos são distintas: para \eqref{eq:anun}, esta é  $|z| > |a|$ e para \eqref{eq:_anun_1}, $|z| < |a|$. A imagem \ref{fig:ex2d} apresenta as regiões visualmente.
