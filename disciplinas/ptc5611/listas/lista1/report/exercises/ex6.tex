...
\newpage
    ...
    \begin{figure}[H]
	\center
	\includegraphics[width=0.8\textwidth]{errozoh.pdf}
	\caption{Curva original e série amostrada}
	\label{fig:ex6erro}
    \end{figure}
    ...
    \begin{figure}[H]
	\center
	\includegraphics[width=0.8\textwidth]{ex6simcontinuo.pdf}
    ...
    \begin{figure}[H]
	\center
	\includegraphics[width=0.8\textwidth, trim=4cm 6cm 3cm 3cm]{ex6simdiscreto.pdf}
