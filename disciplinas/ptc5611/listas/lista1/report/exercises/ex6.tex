...
\addcontentsline{toc}{section}{Exercício 6}
    ...
    \begin{figure}[H]
	\center
	\includegraphics[trim=200 200 200 200, width=0.3\textwidth]{images/ex6continuo.pdf}
    ...
    \begin{figure}[H]
	\center
	\includegraphics[trim=200 200 200 200, width=0.3\textwidth]{images/ex6discreto.pdf}
