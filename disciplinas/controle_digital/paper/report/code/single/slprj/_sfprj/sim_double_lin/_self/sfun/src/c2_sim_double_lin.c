...
#include <stddef.h>
#include "blas.h"
#include "sim_double_lin_sfun.h"
#include "c2_sim_double_lin.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "sim_double_lin_sfun_debug_macros.h"
...
static void initialize_c2_sim_double_lin(SFc2_sim_double_linInstanceStruct
  *chartInstance);
static void initialize_params_c2_sim_double_lin
  (SFc2_sim_double_linInstanceStruct *chartInstance);
static void enable_c2_sim_double_lin(SFc2_sim_double_linInstanceStruct
  *chartInstance);
static void disable_c2_sim_double_lin(SFc2_sim_double_linInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_sim_double_lin
  (SFc2_sim_double_linInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_sim_double_lin
  (SFc2_sim_double_linInstanceStruct *chartInstance);
static void set_sim_state_c2_sim_double_lin(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_sim_double_lin(SFc2_sim_double_linInstanceStruct
  *chartInstance);
static void sf_gateway_c2_sim_double_lin(SFc2_sim_double_linInstanceStruct
  *chartInstance);
static void mdl_start_c2_sim_double_lin(SFc2_sim_double_linInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_sim_double_lin(SFc2_sim_double_linInstanceStruct
  *chartInstance);
static void initSimStructsc2_sim_double_lin(SFc2_sim_double_linInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct *chartInstance,
  const mxArray *c2_b_xhat_, const char_T *c2_identifier, real_T c2_b_y[4]);
static void c2_b_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const char_T *c2_identifier);
static real_T c2_d_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[4]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_f_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[8]);
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_g_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[8]);
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_h_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_b_y[16]);
...
static real_T c2_eml_xdotu(SFc2_sim_double_linInstanceStruct *chartInstance,
  real_T c2_b_x[4], real_T c2_b_y[4]);
static void c2_eml_scalar_eg(SFc2_sim_double_linInstanceStruct *chartInstance);
static void c2_threshold(SFc2_sim_double_linInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_sim_double_linInstanceStruct *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_sim_double_linInstanceStruct *chartInstance);
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_i_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_j_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_sim_double_lin, const char_T *
  c2_identifier);
static uint8_T c2_k_emlrt_marshallIn(SFc2_sim_double_linInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static real_T c2_get_v(SFc2_sim_double_linInstanceStruct *chartInstance,
  uint32_T c2_elementIndex);
static void c2_set_v(SFc2_sim_double_linInstanceStruct *chartInstance, uint32_T
                     c2_elementIndex, real_T c2_elementValue);
static real_T *c2_access_v(SFc2_sim_double_linInstanceStruct *chartInstance,
  uint32_T c2_rdOnly);
static real_T c2_get_xhat(SFc2_sim_double_linInstanceStruct *chartInstance,
  uint32_T c2_elementIndex);
static void c2_set_xhat(SFc2_sim_double_linInstanceStruct *chartInstance,
  uint32_T c2_elementIndex, real_T c2_elementValue);
static real_T *c2_access_xhat(SFc2_sim_double_linInstanceStruct *chartInstance,
  uint32_T c2_rdOnly);
static void init_dsm_address_info(SFc2_sim_double_linInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_sim_double_linInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_sim_double_lin = 0U;
}
  ...
  (SFc2_sim_double_linInstanceStruct *chartInstance)
{
  ...
  c2_b_hoistedGlobal = chartInstance->c2_is_active_c2_sim_double_lin;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_u = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c2_is_active_c2_sim_double_lin = c2_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_b_u, 2)),
     "is_active_c2_sim_double_lin");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_sim_double_lin(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_sim_double_lin(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_sim_double_linMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_sim_double_linInstanceStruct *chartInstance;
  chartInstance = (SFc2_sim_double_linInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_sim_double_lin_get_eml_resolved_functions_info(void)
{
  ...
  c2_identifier)
{
  ...
  c2_b_y = c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_sim_double_lin), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_sim_double_lin);
  return c2_b_y;
}
...
void sf_c2_sim_double_lin_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_sim_double_lin_get_post_codegen_info(void);
mxArray *sf_c2_sim_double_lin_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_sim_double_lin_get_post_codegen_info();
...
mxArray *sf_c2_sim_double_lin_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_sim_double_lin_jit_fallback_info(void)
{
...
mxArray *sf_c2_sim_double_lin_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_sim_double_lin(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[4],T\"u\",},{M[1],M[5],T\"xhat_\",},{M[8],M[0],T\"is_active_c2_sim_double_lin\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_sim_double_lin_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_sim_double_linInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_sim_double_linMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_sim_double_linMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _sim_double_linMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c2_sim_double_lin(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_sim_double_linInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_sim_double_lin((SFc2_sim_double_linInstanceStruct*)
    chartInstanceVar);
  initialize_c2_sim_double_lin((SFc2_sim_double_linInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_sim_double_lin(void *chartInstanceVar)
{
  enable_c2_sim_double_lin((SFc2_sim_double_linInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_sim_double_lin(void *chartInstanceVar)
{
  disable_c2_sim_double_lin((SFc2_sim_double_linInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_sim_double_lin(void *chartInstanceVar)
{
  sf_gateway_c2_sim_double_lin((SFc2_sim_double_linInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_sim_double_lin(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_sim_double_lin((SFc2_sim_double_linInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_sim_double_lin(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_sim_double_lin((SFc2_sim_double_linInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_sim_double_lin(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_sim_double_linInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_sim_double_lin_optimization_info();
    }

    finalize_c2_sim_double_lin((SFc2_sim_double_linInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_sim_double_lin((SFc2_sim_double_linInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_sim_double_lin(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_sim_double_lin(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_sim_double_lin_optimization_info();
...
static void mdlRTW_c2_sim_double_lin(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_sim_double_lin(SimStruct *S)
{
  SFc2_sim_double_linInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_sim_double_linInstanceStruct *)utMalloc(sizeof
    (SFc2_sim_double_linInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_sim_double_linInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_sim_double_lin;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_sim_double_lin;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_sim_double_lin;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_sim_double_lin;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_sim_double_lin;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_sim_double_lin;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_sim_double_lin;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_sim_double_lin;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_sim_double_lin;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_sim_double_lin;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_sim_double_lin;
...
void c2_sim_double_lin_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_sim_double_lin(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_sim_double_lin(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_sim_double_lin(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_sim_double_lin_method_dispatcher.\n"
