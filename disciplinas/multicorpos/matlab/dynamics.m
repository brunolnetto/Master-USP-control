...
T_0i = @(angle, L) T2d(angle, di(0))*T2d(0, di(L)); 

T_01 = T_0i(beta1, L01);
T_02 = T_0i(beta2, L02);
T_03 = T_0i(beta3, L03);

T011 = T_01*T2d(th11, di(0));
T012 = T_02*T2d(th12, di(0));
T013 = T_03*T2d(th13, di(0));
...
T021 = T011*T2d(0, di(L11))*T2d(th21, di(0));
T022 = T012*T2d(0, di(L12))*T2d(th22, di(0));
T023 = T013*T2d(0, di(L13))*T2d(th23, di(0));
